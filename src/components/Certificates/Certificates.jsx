  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div className="blob bg-purple-600/5 dark:bg-purple-600/10 light:bg-purple-300/5 w-80 h-80 top-1/2 left-2/3 blur-[100px]" />
      </div>
        ...
        <div className="flex flex-wrap justify-center gap-8">
          {certificates.map((cert, idx) => (
            <motion.div
              ...
              whileHover={{ 
                y: -8,
                boxShadow: "0 20px 40px rgba(167, 139, 250, 0.12)",
                borderColor: "rgba(167, 139, 250, 0.3)"
              }}
              className="glass-panel-dark dark:glass-panel-dark light:glass-panel-light p-8 rounded-2xl border border-slate-800 dark:border-slate-800 light:border-slate-200 w-full max-w-md flex flex-col group transition-all duration-300 relative overflow-hidden"
            >
              {/* Corner Badge */}
              ...
              <div className="flex items-center space-x-4 mb-4">
                ...
                <div>
                  ...
                  <h4 className="text-xl font-display font-bold text-slate-100 dark:text-slate-100 light:text-slate-900 group-hover:text-accent transition-colors duration-300">
                    {cert.name}
                  </h4>
                </div>
              </div>
